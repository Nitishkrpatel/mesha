...
import wall from 'assets/glb/block15.glb';
...
const SceneComponent = ({ data }) => {
    ...
    useEffect(() => {
        if (renderCanvas.current) {
            ...
            const camera = new ArcRotateCamera("camera", Math.PI / 2, Math.PI / 2, 40, new Vector3(0, 0, 0), scene);
            ...
            data.children.forEach((child, index) => {
                ...
                const position = new Vector3(0, 9 * index, 0); // Example: arrange buildings in a line
