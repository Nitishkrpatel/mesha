...
export default function Dashboard(props) {
  const { keycloak, authenticated, logout, login } =
  ...
  const filteredRoutes = isSuperAdmin
    ? routes.filter(
        (route) =>
          route.name === "Tenant Mangement" || route.path === "/profileSettings"
      )
    : routes.filter((route) => route.name !== "Tenant Mangement");
